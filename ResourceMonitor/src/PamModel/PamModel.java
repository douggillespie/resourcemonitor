...
import resourceMonitor.ResourceMonitor;
...
//		mi.setMaxNumber(1); 
		...
		mi = PamModuleInfo.registerControlledUnit(ResourceMonitor.class.getName(), "Resource Monitor");
		mi.setToolTipText("Monitors computer memory");
		mi.setModulesMenuGroup(utilitiesGroup);	
